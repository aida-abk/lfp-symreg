...
def choose_trials(data: TrialData, dataset: str, value: str | None, max_trials: int | None) -> list[int]:
  if value:
...
def main() -> None:
  ...
  parser.add_argument("--highpass-hz", type=optional_float, default=None)
  ...
  trials = choose_trials(data, args.dataset, args.trials, args.max_trials)
